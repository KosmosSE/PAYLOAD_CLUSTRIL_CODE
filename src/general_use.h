...
// Definições para o sensor ADXL375
...
#define buttonPin 4 // Pino do botão de acionamento do sistema

#define SeaLevelHpa 1013.25 // Pressão ao nível do mar em hPa

#define EstimatedApogee 2000 // Valor em metros, deve ser superior ao apogeu real, para evitar ruído do barômetro, se necessário
